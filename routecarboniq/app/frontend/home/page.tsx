        ...
        <header className="mb-8 flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <div>
            <h1 className="text-4xl font-bold tracking-tight text-slate-800 sm:text-5xl">
              Hello,{" "}
              <span className="text-emerald-500/90">{user.displayName}</span>
            </h1>
          ...
          >
            ...
            <MoveRight
              size={16}
              className="ml-1 opacity-50 transition-transform group-hover:translate-x-1 group-hover:opacity-100"
            />
          </Link>
        </header>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          >
            <div>
              ...
              <p className="mt-2 text-sm font-medium leading-relaxed text-slate-400">
                Explore trends in transit usage and carbon impact.
              </p>
            </div>
